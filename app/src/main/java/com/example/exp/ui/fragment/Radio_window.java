...
import com.example.exp.ui.adapter.Radio_adapter;
...
public class Radio_window extends Fragment {
    private static final String TAG = "log";
    private static Radio_window frg;
    private volleyRequestData rq ;
    private Radio_adapter rcView ;
    ...
    public static Radio_window getInstance() {
        frg = new Radio_window();
        return frg;
    }
    ...
    public void updateUi(ArrayList<PlayerContent> resp) throws JSONException, IOException {
        ...
        rcView = new Radio_adapter(resp,ctx,this.player);
